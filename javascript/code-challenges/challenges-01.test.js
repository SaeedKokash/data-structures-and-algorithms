...
const fizzbuzz = (arr) => {
  ...
  arr.forEach(value => ((value % 3 === 0) && (value % 5 === 0)) ? newArr.push(`Fizz Buzz`) : (value % 5 === 0) ? newArr.push(`Buzz`) : (value % 3 === 0) ? newArr.push(`Fizz`) : newArr.push(value));
